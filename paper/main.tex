...
To address the off-manifold bottleneck, we see two complementary
strategies:
(1)~\textbf{Decoder adaptation} via lightweight LoRA fine-tuning of the
...
(2)~\textbf{diffusion-based decoding}, inspired by Unified
...
should employ lightweight decoder adaptation (e.g., LoRA) or
diffusion-based decoding~\cite{heek2026unified}, which we hypothesize
to be more tolerant of distributional shift in latent space.
